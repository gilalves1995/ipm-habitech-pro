jQuery("#simulation")
  .on("click", ".s-60aa9654-b46a-4d4d-8644-59cb726b899a .click", function(event, data) {
  ...
  .on("pageload", ".s-60aa9654-b46a-4d4d-8644-59cb726b899a .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-60aa9654-b46a-4d4d-8644-59cb726b899a")) {
      cases = [
        {
          "blocks": [
            {
