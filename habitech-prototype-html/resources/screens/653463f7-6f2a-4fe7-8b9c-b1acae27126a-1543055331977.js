jQuery("#simulation")
  .on("click", ".s-653463f7-6f2a-4fe7-8b9c-b1acae27126a .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is(".s-roomTypeImage")) {
      cases = [
        {
          "blocks": [
            {
