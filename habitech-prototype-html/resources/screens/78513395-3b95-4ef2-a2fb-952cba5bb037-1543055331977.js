jQuery("#simulation")
  .on("click", ".s-78513395-3b95-4ef2-a2fb-952cba5bb037 .click", function(event, data) {
  ...
  .on("pageload", ".s-78513395-3b95-4ef2-a2fb-952cba5bb037 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-78513395-3b95-4ef2-a2fb-952cba5bb037")) {
      cases = [
        {
          "blocks": [
            {
