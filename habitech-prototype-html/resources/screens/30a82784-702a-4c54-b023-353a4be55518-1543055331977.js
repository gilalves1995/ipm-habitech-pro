jQuery("#simulation")
  .on("click", ".s-30a82784-702a-4c54-b023-353a4be55518 .click", function(event, data) {
  ...
  .on("pageload", ".s-30a82784-702a-4c54-b023-353a4be55518 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-30a82784-702a-4c54-b023-353a4be55518")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-intensity-value")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-mode-label_1")) {
      cases = [
        {
          "blocks": [
            {
