jQuery("#simulation")
  .on("click", ".s-0b139b7a-334c-4ee5-94f3-73eaa227da56 .click", function(event, data) {
  ...
  .on("pageload", ".s-0b139b7a-334c-4ee5-94f3-73eaa227da56 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-0b139b7a-334c-4ee5-94f3-73eaa227da56")) {
      cases = [
        {
          "blocks": [
            {
