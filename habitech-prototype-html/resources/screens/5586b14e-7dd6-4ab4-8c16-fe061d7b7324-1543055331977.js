jQuery("#simulation")
  .on("click", ".s-5586b14e-7dd6-4ab4-8c16-fe061d7b7324 .click", function(event, data) {
  ...
  .on("pageload", ".s-5586b14e-7dd6-4ab4-8c16-fe061d7b7324 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-5586b14e-7dd6-4ab4-8c16-fe061d7b7324")) {
      cases = [
        {
          "blocks": [
            {
