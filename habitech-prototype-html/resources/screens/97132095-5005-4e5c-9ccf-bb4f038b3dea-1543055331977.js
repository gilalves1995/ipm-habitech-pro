jQuery("#simulation")
  .on("click", ".s-97132095-5005-4e5c-9ccf-bb4f038b3dea .click", function(event, data) {
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  ...
                  "parameter": {
                    "target": "screens/24a138c8-eed7-457e-ac54-3af4706cf9c1"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("pageload", ".s-97132095-5005-4e5c-9ccf-bb4f038b3dea .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is(".s-roomDevicesNumber")) {
      cases = [
        {
          "blocks": [
            {
