jQuery("#simulation")
  .on("click", ".s-a148e6f5-fa45-4175-bb17-55861f58aa3c .click", function(event, data) {
  ...
  .on("pageload", ".s-a148e6f5-fa45-4175-bb17-55861f58aa3c .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-a148e6f5-fa45-4175-bb17-55861f58aa3c")) {
      cases = [
        {
          "blocks": [
            {
