jQuery("#simulation")
  .on("click", ".s-0dc8c279-078c-4556-8672-fbb449c1d738 .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is(".s-roomImage")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("pageload", ".s-0dc8c279-078c-4556-8672-fbb449c1d738 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
