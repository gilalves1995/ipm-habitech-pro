jQuery("#simulation")
  .on("click", ".s-daa9e52b-b7ea-4484-85d3-4da10b4bd8ae .click", function(event, data) {
  ...
  .on("pageload", ".s-daa9e52b-b7ea-4484-85d3-4da10b4bd8ae .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-daa9e52b-b7ea-4484-85d3-4da10b4bd8ae")) {
      cases = [
        {
          "blocks": [
            {
