jQuery("#simulation")
  .on("click", ".s-81b32b1a-689d-4ef6-846d-a8b9d67e35d8 .click", function(event, data) {
  ...
  .on("pageload", ".s-81b32b1a-689d-4ef6-846d-a8b9d67e35d8 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-81b32b1a-689d-4ef6-846d-a8b9d67e35d8")) {
      cases = [
        {
          "blocks": [
            {
