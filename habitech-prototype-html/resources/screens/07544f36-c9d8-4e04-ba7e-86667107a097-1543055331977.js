jQuery("#simulation")
  .on("click", ".s-07544f36-c9d8-4e04-ba7e-86667107a097 .click", function(event, data) {
  ...
  .on("pageload", ".s-07544f36-c9d8-4e04-ba7e-86667107a097 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
